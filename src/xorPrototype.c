...
=======
  ...
  return cost;
  free(cost);
>>>>>>> a0898fa655f762a32439d6e1d9a78a1044677293:OCRap/src/xorPrototype.c
}
...
<<<<<<< HEAD:OCRap/xorPrototype.c
void gradient_descent(NeuralNetworkInit *net, float *w2
		float *b2, float *w1, float *b1)
=======
void gradient_descent(NeuralNetworkInit *net, float *w2,
		      float *b2, float *w1, float *b1)
>>>>>>> a0898fa655f762a32439d6e1d9a78a1044677293:OCRap/src/xorPrototype.c
